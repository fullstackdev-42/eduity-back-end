    ...
    public function __invoke(Request $request)
    {
        ...
        if($organizationId > 0){
            ...
            $data = [
                ...
                "naicsMajor" => $organization->getNaicsMajor(), //number
            ...
            // return new JsonResponse(['status' => 'success', 'msg' => 'The organization has been added successfully.'], 201);
        } else {
