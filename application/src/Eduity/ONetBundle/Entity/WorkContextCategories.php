...
/**
 * WorkContextCategories
 *
 * @ORM\Table(name="work_context_categories", indexes={@ORM\Index(name="scale_id", columns={"scale_id"}), @ORM\Index(name="IDX_809691AB1F1F2A24", columns={"element_id"})})
 * @ORM\Entity
 */
class WorkContextCategories
{
    /**
     * @var string
     *
