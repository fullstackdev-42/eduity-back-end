 ...
 *
 * @ORM\Table(name="education_training_experience", indexes={@ORM\Index(name="element_id", columns={"element_id", "scale_id", "category"}), @ORM\Index(name="onetsoc_code", columns={"onetsoc_code"}), @ORM\Index(name="scale_id", columns={"scale_id"}), @ORM\Index(name="IDX_2AF048461F1F2A24", columns={"element_id"}), @ORM\Index(name="IDX_2AF0484664C19C11F1F2A24F73142C2", columns={"category", "element_id", "scale_id"})})
 * @ORM\Entity
 */
class EducationTrainingExperience
{
    /**
     * @var string
     *
     ...
     * @var \EteCategories
     *
     * @ORM\ManyToOne(targetEntity="EteCategories")
     * @ORM\JoinColumns({
