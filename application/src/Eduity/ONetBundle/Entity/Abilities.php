 ...
 * Abilities
 *
 * @ORM\Table(name="abilities", indexes={@ORM\Index(name="element_id", columns={"element_id"}), @ORM\Index(name="onetsoc_code", columns={"onetsoc_code"}), @ORM\Index(name="scale_id", columns={"scale_id"})})
 * @ORM\Entity
 */
class Abilities
{
